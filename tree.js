...
var tree = new Tree();
tree.add({name:'ceo'});
tree.add({name:'cto' },  {name:'ceo'});
tree.add({name:'dev1'}, {name:'cto'});
tree.add({name:'dev2'}, {name:'cto'});
tree.add({name:'dev3'}, {name:'cto'});
tree.add({name:'cfo' },  {name:'ceo'});
tree.add({name:'accountant'},{ root:'cfo'});
tree.add({name:'cmo'}, {root:'ceo'});
tree.print(); // => ceo | cto cfo cmo | dev1 dev2 dev3 accountant
tree.printByLevel();  // => ceo \n cto cfo cmo \n dev1 dev2 dev3 accountant
console.log('tree contains dev1 is true:', tree.contains({name:'dev1'})); // => true
console.log('tree contains dev4 is false:', tree.contains({name:'dev4'})); // => false
console.log('--- BFS');
